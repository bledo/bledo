...
public final class Logger {
	...
	private synchronized void _init()
	{
		...
		//
		try {
			rawProps = co.bledo.Util.loadProperties("bledo.properties");
		} catch (Exception e) {
		...
		for (String writerLabel : writersProps.getRootKeys())
		{
			...
			try { writer = (LoggerWritter) co.bledo.Util.loadClass(writerClass, new Object[]{}); } catch (Exception e) { continue; }
